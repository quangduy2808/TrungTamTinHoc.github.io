...
<div class="row">
	<div class="col-sm-6">
		<form:form id="editForm" method="post" modelAttribute="employee"
			data-parsley-validate="data-parsley-validate">

			<div class="form-group row">
				<label class="form-control-label col-sm-3">Họ và tên<span
			...
			<div class="form-group row">
				<label class="form-control-label col-sm-3">Phone<span
					class="required">*</span></label>
				<div class="col-sm-9">
			...
			<div class="form-group row">
				<label class="form-control-label col-sm-3">Department<span
					class="required">*</span></label>
				<div class="col-sm-9">
