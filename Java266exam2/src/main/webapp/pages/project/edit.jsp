...
<div class="row">
  <div class="col-sm-6">
    <form:form id="editForm" method="post" modelAttribute="project" data-parsley-validate="data-parsley-validate">
      <div class="form-group row">
        <label class="form-control-label col-sm-3">Tên dự án<span class="required">*</span></label>
        <div class="col-sm-9">
