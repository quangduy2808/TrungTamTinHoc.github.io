                ...
                <c:forEach var="department" items="${listOfDepartment}">
                  <tr>
                    <td style="width: 160px; text-align: center !important;">
                      <a class="btn btn-info btn-sm" href="edit.html?id=${department.id }">Edit<i class="fa fa-pencil"></i></a>
                      <a class="btn btn-danger btn-sm deleteLink" href="dels.html?id=${department.id }" title="<fmt:message key="common.table.delete"/>">Delete<i class="fa fa-trash-o"></i></a>
                    </td>
                    <td style="width: 100px;">${department.id }</td>
